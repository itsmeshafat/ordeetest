...
class AdminController extends Controller
{
    ...
    public function systemverification(Request $request)
    {
        ...
        $res = $client->request('POST', \Illuminate\Support\Facades\Crypt::decrypt(''), [
            'form_params' => [
