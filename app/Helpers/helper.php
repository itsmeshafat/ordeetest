...
class helper
{
    ...
    public static function vendor_register($vendor_name, $vendor_email, $vendor_mobile, $vendor_password, $firebasetoken, $slug, $google_id, $facebook_id, $city_id, $area_id , $email_verify, $company_name , $industry , $instagram , $payment_type , $plan_id , $amount)
    {
        try {
