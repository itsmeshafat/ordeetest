        ...
        <div class="container">
            ...
            <div class="d-flex gap-2">
                ...
                <div class="d-flex justify-content-end d-none d-lg-block">
                    <a href="<?php echo e(URL::to('/admin')); ?>" class="btn btn-secondary rounded h-45 text-end" target="_blank"><span class="m-0  fs-6"><?php echo e(trans('landing.get_started')); ?></a>
                </div>
            </div>
...
<?php echo $__env->make('cookie-consent::index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/ordee.store/httpdocs/resources/views/landing/layout/header.blade.php ENDPATH**/ ?>