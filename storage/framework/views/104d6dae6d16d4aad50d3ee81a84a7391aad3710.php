<nav aria-label="breadcrumb">
    ...
    <ol class="breadcrumb breadcrumb-rtl">
        ...
        <?php if(request()->is('admin/industries')): ?>

        <li class="breadcrumb-item active <?php echo e(session()->get('direction') == 2 ? 'breadcrumb-rtl' : ''); ?>" aria-current="page"><?php echo e(trans('industries')); ?></li>

        <?php endif; ?>

        <?php if(request()->is('admin/industries/add') || request()->is('admin/industries/edit-*')): ?>

        <li class="breadcrumb-item active <?php echo e(session()->get('direction') == 2 ? 'breadcrumb-rtl' : ''); ?>" aria-current="page">

            <a href="<?php echo e(URL::to('admin/industries')); ?>"><?php echo e(trans('industries')); ?></a>
        </li>

            <?php if(request()->is('admin/industries/edit-*')): ?>

            <li class="breadcrumb-item active <?php echo e(session()->get('direction') == 2 ? 'breadcrumb-rtl' : ''); ?>" aria-current="page"><?php echo e(trans('edit')); ?></li>

            <?php else: ?>

            <li class="breadcrumb-item active <?php echo e(session()->get('direction') == 2 ? 'breadcrumb-rtl' : ''); ?>" aria-current="page"><?php echo e(trans('add')); ?></li>
...
</nav><?php /**PATH H:\laragon\www\ordee\resources\views/admin/layout/breadcrumb.blade.php ENDPATH**/ ?>