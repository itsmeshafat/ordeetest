<nav aria-label="breadcrumb">
    ...
    <ol class="breadcrumb breadcrumb-rtl">
        ...
        @if(request()->is('admin/industries'))

        <li class="breadcrumb-item active {{session()->get('direction') == 2 ? 'breadcrumb-rtl' : ''}}" aria-current="page">{{ trans('industries') }}</li>

        @endif

        @if(request()->is('admin/industries/add') || request()->is('admin/industries/edit-*'))

        <li class="breadcrumb-item active {{session()->get('direction') == 2 ? 'breadcrumb-rtl' : ''}}" aria-current="page">

            <a href="{{ URL::to('admin/industries') }}">{{ trans('industries')}}</a>
        </li>

            @if(request()->is('admin/industries/edit-*'))

            <li class="breadcrumb-item active {{session()->get('direction') == 2 ? 'breadcrumb-rtl' : ''}}" aria-current="page">{{ trans('edit') }}</li>

            @else

            <li class="breadcrumb-item active {{session()->get('direction') == 2 ? 'breadcrumb-rtl' : ''}}" aria-current="page">{{ trans('add') }}</li>
