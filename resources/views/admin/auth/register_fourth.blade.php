    ...
    <div class="modal fade" id="modalbankdetails" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalbankdetailsLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form enctype="multipart/form-data" action="{{ URL::to('admin/register_vendor_complete') }}" method="POST">
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="name" id="modal_amount" class="form-control" value="{{ Session::get('name') }}">
                        <input type="hidden" name="email" id="modal_amount" class="form-control" value="{{ Session::get('email') }}">
                        <input type="hidden" name="mobile" id="modal_amount" class="form-control" value="{{ Session::get('mobile') }}">
                        <input type="hidden" name="password" id="modal_amount" class="form-control" value="{{ Session::get('password') }}">
                        <input type="hidden" name="email_verified" id="modal_amount" class="form-control" value="{{ Session::get('email_verified') }}">
                        <input type="hidden" name="company_name" id="modal_amount" class="form-control" value="{{ Session::get('company_name') }}">
                        <input type="hidden" name="industry" id="modal_amount" class="form-control" value="{{ Session::get('industry') }}">
                        <input type="hidden" name="city" id="modal_amount" class="form-control" value="{{ Session::get('city') }}">
                        <input type="hidden" name="area" id="modal_amount" class="form-control" value="{{ Session::get('area') }}">
                        <input type="hidden" name="instagram" id="modal_amount" class="form-control" value="{{ Session::get('instagram') }}">
