...
Route::group(['namespace' => 'admin', 'prefix' => 'admin'], function () {
    ...
    Route::get('register_vendor_first', [VendorController::class, 'register_vendor_first']);
    Route::get('register_vendor_second', [VendorController::class, 'register_vendor_second']);
    Route::get('register_vendor_third', [VendorController::class, 'register_vendor_third']);
    Route::get('register_vendor_fourth', [VendorController::class, 'register_vendor_fourth']);
    Route::post('register_vendor_complete', [VendorController::class, 'register_vendor_complete']);
                ...
                function () {
                    ...
                    Route::group(
                        ...
                        function () {
                            ...
                            Route::get('/add', [IndustryController::class, 'create']);
                            Route::post('/save', [IndustryController::class, 'store']);
                            Route::get('/edit-{id}', [IndustryController::class, 'edit']);
                            Route::post('/update-{id}', [IndustryController::class, 'update']);
                            Route::get('/delete-{id}', [IndustryController::class, 'destroy']);
                            Route::get('/change_status-{id}/{status}', [IndustryController::class, 'statuschange_industry']);
                        }
                    );
